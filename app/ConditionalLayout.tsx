        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <a href="/" className="flex items-center gap-3 group">
              ...
              <div>
                <h1
                  className="text-2xl font-bold text-[var(--deep-brown)]"
      ...
      <footer className="mt-20 bg-gradient-to-b from-[var(--muted-mauve)] to-[var(--soft-peach)] border-t border-[var(--warm-coral)]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3
                className="text-xl font-bold mb-4 text-[var(--deep-brown)] font-[family-name:var(--font-display)]"
                style={{ fontFamily: "'Caveat', cursive" }}
              >
                Kocia Oaza
              </h3>
          ...
          <div className="mt-8 pt-8 border-t border-[var(--warm-coral)]/20 text-center text-sm text-[var(--soft-brown)]">
            <p>© 2026 Kocia Oaza. Każdy kotek zasługuje na miłość.</p>
          </div>
        </div>
      </footer>
    </>
