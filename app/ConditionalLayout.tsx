          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-4">
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.75 2h2.25c.2 1.7 1.6 3.1 3.3 3.3v2.3c-1.2 0-2.4-.4-3.3-1.1v6.6c0 3.1-2.5 5.6-5.6 5.6S3.8 16.2 3.8 13.1s2.5-5.6 5.6-5.6c.3 0 .6 0 .9.1v2.4c-.3-.1-.6-.2-.9-.2-1.8 0-3.2 1.4-3.2 3.2s1.4 3.2 3.2 3.2 3.2-1.4 3.2-3.2V2z" />
                  </svg>
                </a>
              </div>
            </div>
